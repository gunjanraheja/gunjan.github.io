const IMAGE_URL = "https://raw.githubusercontent.com/gunjanraheja/gunjan.github.io/master/pk_logo.png";
...
function setup() {
  const canvasWidth = targetImage.width + PADDING * 0.25;
  const canvasHeight = targetImage.height + PADDING * 0.25;
